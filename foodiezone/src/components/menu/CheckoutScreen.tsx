          ...
          <div className="px-5 pb-8 pt-2">
            ...
            <div className="mb-4" style={{ border: '1px solid rgba(255,255,255,0.08)' }}>
              ...
              <div className="flex justify-between px-4 py-3" style={{ background: '#0A0A0A' }}>
                ...
                <span className="font-heading font-bold text-[14px]" style={{ color: '#FF6B00' }}>R{total + DELIVERY_FEE}</span>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-3 text-[13px] font-body text-white focus:outline-none transition-colors"
                style={{
                  background: '#1E1E1E',
                  border: `2px solid ${addressFocused ? '#CC0000' : 'rgba(255,255,255,0.1)'}`,
            ...
            <button
              ...
              className="w-full text-white font-heading font-bold py-4 transition-all duration-150 text-[15px] uppercase tracking-wide disabled:opacity-40 disabled:cursor-not-allowed active:scale-[0.98]"
              style={{ background: placing ? '#555' : '#CC0000' }}
            >
              {placing ? (
